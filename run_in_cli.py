...
DOCUMENT_DIR = Path(__file__).parent.parent.joinpath("documents")
...
if __name__ == "__main__":
    ...
    vector_store = Chroma.from_documents(documents=processed_pdf_documents, embedding=OllamaEmbeddings(base_url="http://localhost:7869", model="nomic-embed-text:v1.5"))

    llm = Ollama(base_url="http://localhost:7869", model="gpt-oss:20b", verbose=True)
